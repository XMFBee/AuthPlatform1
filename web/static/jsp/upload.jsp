    ...
    if (contentType.indexOf("multipart/form-data") >= 0) {
        ...
        while (fileItems.hasNext()) {
            ...
            //如果是原始图片 file 域的名称或者以默认的头像域名称的部分“__avatar”打头
                ...
                String virtualPath = "/static/uploads/jsp_avatar" + avatarNumber + "_" + fileName + ".jpg";
                //原始图片（默认的 file 域的名称是__source，可在插件配置参数中自定义。参数名：src_field_name）。
                if (isSourcePic) {
                    result.sourceUrl = virtualPath = "/static/uploads/jsp_source_" + fieldName + ".jpg";
                }
                ...
                inputStream = new BufferedInputStream(fileItem.openStream());
                String file = application.getRealPath("/static");
                File uploadfile = new File(file, "uploads");
