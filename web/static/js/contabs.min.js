...
// 跳转到维修保养明细打印页面
function addRecordPrint(maintainRecordId, ids){
    //  o 为菜单栏li的href
    var o = "/backstage/recordPrint/"+maintainRecordId+"/"+ids, m = "100", l = "维修保养明细打印", k = true;
    if (o == undefined || $.trim(o).length == 0) {
        return false
    }
    $(".J_menuTab").each(function () {
...
function addChargeBillPrint(chargeBillId){
    //  o 为菜单栏li的href
    var o = "/backstage/chargeBillprint/"+chargeBillId, m = "101", l = "收费单据打印", k = true;
    if (o == undefined || $.trim(o).length == 0) {
        return false
    }
    $(".J_menuTab").each(function () {
