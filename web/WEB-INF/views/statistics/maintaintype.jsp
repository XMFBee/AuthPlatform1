    ...
    <div class='tab-content'>
        ...
        <div class='tab-pane' id='tab2'>
            <div class="form-inline">
                ...
                <div class="project"  style="width: 150px;">
                    <label>项目类型:</label>
                    <select id="monthMaintainTypeId" name="" class="form-control select2">
                        <option>维修</option>
                        <option>保养</option>
                    </select>
                </div>
                <div class="proname" style="width: 200px;">
                    <label>项目名字:</label>
                    <select id="monthMaintainId" name="maintainId" class="form-control select2 maintainName" style="width: 60%;" >
        ...
        <div class='tab-pane' id='tab3'>
            <div class="form-inline">
                ...
                <div class="project"  style="width: 150px;">
                    <label>项目类型:</label>
                    <select id="dayMaintainTypeId" name="" class="form-control select2">
                        <option>维修</option>
                        <option>保养</option>
                    </select>
                </div>
                <div class="proname" style="width: 200px;">
                    <label>项目名字:</label>
                    <select id="dayMaintainId" name="maintainId" class="form-control select2 maintainName" style="width: 60%;" >
        ...
        <div class='tab-pane' id='tab4'>
            <div class="form-inline">
                ...
                <div class="project"  style="width: 150px;">
                    <label>项目类型:</label>
                    <select id="quarterMaintainTypeId" name="" class="form-control select2">
                        <option>维修</option>
                        <option>保养</option>
                    </select>
                </div>
                <div class="proname" style="width: 200px;">
                    <label>项目名字:</label>
                    <select id="quarterMaintainId" name="maintainId" class="form-control select2 maintainName" style="width: 60%;" >
        ...
        <div class='tab-pane' id='tab5'>
            <div class="form-inline">
                ...
                <div class="project"  style="width: 150px;">
                    <label>项目类型:</label>
                    <select id="weekMaintainTypeId" name="" class="form-control select2">
                        <option>维修</option>
                        <option>保养</option>
                    </select>
                </div>
                <div class="proname" style="width: 200px;">
                    <label>项目名字:</label>
                    <select id="weekMaintainId" name="maintainId" class="form-control select2 maintainName" style="width: 60%;" >
